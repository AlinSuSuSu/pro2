...
class EditProfileAdminForm(FlaskForm):
    ...
    nickname = StringField('nickname', validators=[Required(), Length(1, 64), Regexp('^[A-Za-z][A-Za-z0-9_.]*$', 0,'Usernames must have only letters, ''numbers, dots or underscores')])
    confirmed = BooleanField('Confirmed')
    role = SelectField('Role', coerce=int)
    username = StringField('Realname', validators=[Length(0, 64)])
